...
declare const calendar: {
     ...
     * @param m
     */
    monthDays(y: number, m: number): -1 | 29 | 30;
    /**
     * 返回公历(!)y年m月的天数
     ...
     * @param Day
     */
    solar2lunar(Year?: number | string | Date | Dayjs, Month?: number | string, Day?: number | string): "请检查输入参数的合法性，目前仅支持1901.1.1-2099.12.31之间的查询,传入的时间超出查询范围！" | "请检查输入参数的合法性，月份只能在1~12之间！" | "日期只能在1~31之间！" | {
        lunarYear: number;
        lunarYearCN: string;
        lunarMonth: number;
        lunarDay: number;
